...
foldersTree = gFld("<i><b>Lava/LavaPE Manual</b></i>", "LavaOnlineDoc.htm")
  ...
  aux1 = insFld(foldersTree, gFld("Lava solutions and highlights", "html/LavaOverview.htm"))
    ...
    aux2 = insFld(aux1, gFld("Comprehensive initialization checks", "html/IniChecks.htm"))
  ...
  aux1 = insFld(foldersTree, gFld("<b><i>Index</i></b>", "javascript:parent.op()"))
      ...
      insDoc(aux1, gLnk("R", "documentation generator</i>", "html/PointAndClick.htm#HTMLdoc"))
      ...
      insDoc(aux1, gLnk("R", "initialization checks", "html/ObjectLifeCycle.htm"))
      insDoc(aux1, gLnk("R", "initializer", "html/ObjectLifeCycle.htm#initializer"))
