...
//  void OnUpdateDbgStart(QAction* action);
  ...
  void OnUpdateSucceed(QAction *pb);
  void OnUpdateQua(QAction *pb);
  void OnUpdateItem(QAction *pb);
  void OnUpdateCopy(QAction *pb);
  void OnUpdateAssert(QAction *pb);
  void OnUpdateIgnoreButton(QAction *pb);
  void OnUpdateCreate(QAction *pb);
  void OnUpdateOld(QAction *pb);
  void OnUpdateExists(QAction *pb);
  void OnUpdateCall(QAction *pb);
//  void OnUpdateUuid(QAction *pb);
  void OnUpdateTypeSwitch(QAction *pb);
  void OnUpdateConnect(QAction *pb);
  void OnUpdateDisconnect(QAction *pb);
  void OnUpdateEmitSignal(QAction *pb);
  void OnUpdateAssign(QAction *pb);
  void OnUpdateAttach(QAction *pb);
  void OnUpdateQueryItf(QAction *pb);
  void OnUpdateAnd(QAction *pb);
  void OnUpdateClone(QAction *pb);
  void OnUpdateSelect(QAction *pb);
  void OnUpdateDeclare(QAction *pb);
  void OnUpdateForeach(QAction *pb);
  void OnUpdateIf(QAction *pb);
  void OnUpdateIfdef(QAction *pb);
  void OnUpdateIfExpr(QAction *pb);
  void OnUpdateElseExpr(QAction *pb);
  void OnUpdateIn(QAction *pb);
  void OnUpdateNot(QAction *pb);
  void OnUpdateOr(QAction *pb);
  void OnUpdateSwitch(QAction *pb);
  void OnUpdateXor(QAction *pb);
