...
QString ERR_IllegalVTExtension;
...
//  ERR_ThrowInInitiator  = QObject::tr("In main programs, ""fail"" must not throw a non-null exception ");
  ...
  ERR_ForceOver  = QObject::tr(": Function is declared in a base class and has the \"force override on derivation\" flag and must therefore be overridden in the derived class");
  ...
  ERR_IllegalVTExtension  = QObject::tr("Illegal extension by virtual type in the class or a base class (cannot compute the virtual table)");
  ...
  ERR_OverriddenIOType  = QObject::tr("Overridden input/output parameter has inconsistent type");
