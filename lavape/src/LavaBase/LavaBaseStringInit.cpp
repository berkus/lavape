...
QString ERR_ExInXor;
QString ERR_NotFinitary;
QString ERR_AssignInXor;
...
QString ERR_CallbackHasNoInput;
QString ERR_CallbackWrongEvtArg;
...
QString ERR_NoCallbackFunc;
QString ERR_CallbackHasOutput;
...
void LavaBaseStringInit() {
  ...
  ERR_NotFinitary  = QObject::tr("Forbidden assignment within an ""assignment-free"" construct (if-condition, where/holds-clause, logical ""not"", xor, ""?"")");
  ...
  ERR_CallbackHasOutput  = QObject::tr("Callback function must not have output parameters");
  ...
  ERR_CorruptForm3  = QObject::tr("Member type in iform is not a form of member type in interface");
  ...
  ERR_OneEnum  = QObject::tr("In this interface and/ore in its base interfaces is more then one set of  enumeration items declared");
  ...
  ERR_Placeholder  = QObject::tr("Incomplete program: exec/constraint contains a placeholder");
  ERR_ExecutionFailed  = QObject::tr("Execution failed");
  ERR_EmptyExec  = QObject::tr("Missing or empty exec");
  ERR_AssertionViolation  = QObject::tr("Assertion or constraint violation");
  ERR_NoErrors  = QObject::tr("No errors or placeholders found");
  ERR_ExecError  = QObject::tr("Error in exec/constraint");
  ...
  ERR_NoBaseType  = QObject::tr("Missing declaration of base interface");
  ERR_NoElType  = QObject::tr("Missing declaration of element type");
  ERR_NoBaseIF  = QObject::tr("Missing declaration of a  base interface");
  ...
  ERR_InVTofBaseIF  = QObject::tr("Error in virtual table of a base interface");
  ...
  ERR_RdOnlyFunc  = QObject::tr("Read-only function must not change ""self"" or its constituents");
  ...
  ERR_CallbackHasNoInput  = QObject::tr("Callback function must have at least one input parameter (event descriptor)");
  ERR_CallbackWrongEvtArg  = QObject::tr("The type of the first formal parameter of this callback function (event descriptor) is inconsistent with the associated callback type");
  ...
  ERR_OverInOtherCon  = QObject::tr("You cannot extend an interface that has been declared in another context");
  ...
  ERR_NoIFforForm  = QObject::tr("The associated interface of this GUI service is missing");
